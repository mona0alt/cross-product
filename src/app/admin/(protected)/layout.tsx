...
export default async function AdminProtectedLayout({
  ...
  return (
    <div className="admin-body bg-admin-bg text-admin-text-primary font-body">
      <div className="admin-grid-shell">
        <div className="fixed left-0 top-0 z-40 h-screen w-60 border-r border-[#1E293B] bg-[#0F172A]">
