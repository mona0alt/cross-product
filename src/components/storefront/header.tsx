        ...
        <div className="mk-container flex min-h-[76px] items-center gap-3 py-3 lg:gap-6">
          ...
          <div className="ml-auto flex items-center gap-3 text-white lg:gap-4">
            <a
              ...
              className="hidden h-10 items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-3 text-[13px] font-semibold tracking-[0.02em] text-white/68 transition hover:border-white/25 hover:bg-white/[0.08] hover:text-white 2xl:flex"
            >
