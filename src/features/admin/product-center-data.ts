...
import type { getAdminProductList } from '@/features/catalog/queries';
import type { Locale } from '@/lib/i18n/config';

type AdminProductList = Awaited<ReturnType<typeof getAdminProductList>>;
...
export function mapAdminProductCenterRows(
...
export function mapAdminProductCenterCategories(
